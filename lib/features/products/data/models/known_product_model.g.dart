...
part of 'known_product_model.dart';
...
extension GetKnownProductModelCollection on Isar {
  IsarCollection<KnownProductModel> get knownProductModels => this.collection();
}

const KnownProductModelSchema = CollectionSchema(
  name: r'KnownProductModel',
  id: 4479326249817851358,
  properties: {
  ...
  deserialize: _knownProductModelDeserialize,
  deserializeProp: _knownProductModelDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _knownProductModelGetId,
  getLinks: _knownProductModelGetLinks,
  attach: _knownProductModelAttach,
  version: '3.1.0+1',
);

int _knownProductModelEstimateSize(
...
void _knownProductModelSerialize(
  KnownProductModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
KnownProductModel _knownProductModelDeserialize(
  ...
  final object = KnownProductModel();
  object.createdAt = reader.readDateTime(offsets[0]);
  object.domainId = reader.readString(offsets[1]);
  object.id = id;
  object.name = reader.readString(offsets[2]);
  object.normalizedName = reader.readString(offsets[3]);
  object.updatedAt = reader.readDateTime(offsets[4]);
  return object;
}

P _knownProductModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _knownProductModelGetId(KnownProductModel object) {
  return object.id;
}
...
extension KnownProductModelByIndex on IsarCollection<KnownProductModel> {
  Future<KnownProductModel?> getByDomainId(String domainId) {
    return getByIndex(r'domainId', [domainId]);
  }

  KnownProductModel? getByDomainIdSync(String domainId) {
  ...
  List<KnownProductModel?> getAllByDomainIdSync(List<String> domainIdValues) {
    final values = domainIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByDomainId(KnownProductModel object) {
    return putByIndex(r'domainId', object);
  }

  Id putByDomainIdSync(KnownProductModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'domainId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByDomainId(List<KnownProductModel> objects) {
  ...
  Future<KnownProductModel?> getByNormalizedName(String normalizedName) {
    return getByIndex(r'normalizedName', [normalizedName]);
  }

  KnownProductModel? getByNormalizedNameSync(String normalizedName) {
  ...
  Future<Id> putByNormalizedName(KnownProductModel object) {
  ...
  Future<List<Id>> putAllByNormalizedName(List<KnownProductModel> objects) {
...
extension KnownProductModelQueryWhereSort
    on QueryBuilder<KnownProductModel, KnownProductModel, QWhere> {
  QueryBuilder<KnownProductModel, KnownProductModel, QAfterWhere> anyId() {
...
extension KnownProductModelQueryObject
    on QueryBuilder<KnownProductModel, KnownProductModel, QFilterCondition> {}

extension KnownProductModelQueryLinks
    on QueryBuilder<KnownProductModel, KnownProductModel, QFilterCondition> {}
...
extension KnownProductModelQuerySortThenBy
  ...
  QueryBuilder<KnownProductModel, KnownProductModel, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
...
extension KnownProductModelQueryProperty
    on QueryBuilder<KnownProductModel, KnownProductModel, QQueryProperty> {
  QueryBuilder<KnownProductModel, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KnownProductModel, String, QQueryOperations> domainIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'domainId');
    });
  }

  QueryBuilder<KnownProductModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
